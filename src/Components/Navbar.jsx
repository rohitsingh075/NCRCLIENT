    ...
    <header className="w-full relative top-0 inset-x-0 z-50">
      ...
      {showTrain && (
        <div className="absolute top-0 left-0 w-full z-50">
          <div className="train-animation h-[160px] py-1 px-4 flex justify-start items-center">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center min-w-0 flex-nowrap">
            <Link to="/" className="min-w-0 flex items-center flex-shrink-0">
              <img src={logo} alt="NCR COLLEGE" className="w-8 h-8 mr-1 sm:w-12 sm:h-12 flex-shrink-0" />
