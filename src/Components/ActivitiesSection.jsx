  ...
  return (
    <section className="py-12 bg-white text-center">
      ...
      >
        ...
        <p className="text-center font-bold text-xl text-gray-900 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {[
            ...
            {
              text: "NCR College is a hub of continuous learning, offering a great environment for students’ growth and development. It’s a place where every child gets a 360° development.",
              name: "Praveen Kumar",
              role: "Teacher",
            },
            {
